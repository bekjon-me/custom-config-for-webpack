...
searchBtn.addEventListener("click", (event) => {
  ...
  if (userLocation.value === "") {
    ...
    fetch(
      "https://api.openweathermap.org/data/2.5/weather?q=tashkent&appid=abad344b6b4aba506fc207f3f39d0e92",
      { mode: "cors" }
    )
      ...
      .then(function (response) {
        ...
        dates[0].innerHTML = `${Math.round(
          1 * (response.main.temp - 273)
        )}&#176;`;
    ...
    fetch(
      `https://api.openweathermap.org/data/2.5/weather?q=${userLocation.value}&appid=abad344b6b4aba506fc207f3f39d0e92`,
      { mode: "cors" }
    )
